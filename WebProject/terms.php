...
<head>
    ...
    <title>Terms & Conditions | TrashPandaStudio</title>
...
<body>
    ...
    <section class="legal-section">
        ...
        <div class="legal-placeholder-notice">
            This is placeholder text so the Sign-Up flow has somewhere real to link to. Swap this out for your studio's actual reviewed Terms &amp; Conditions before launch.
        </div>

        <h3>1. Acceptance of Terms</h3>
        <p>By creating an account or using any service offered by TrashPandaStudio, you agree to be bound by these Terms &amp; Conditions.</p>

        <h3>2. Services</h3>
        <p>TrashPandaStudio provides photography, editing, and creative media production services as described on this site. Specific deliverables, timelines, and pricing are agreed upon per project.</p>
        ...
        <h3>4. Payments</h3>
        <p>Accepted payment methods and terms will be confirmed at the time of booking. Refund and cancellation policies will be detailed here.</p>

        <h3>5. Changes to These Terms</h3>
        <p>TrashPandaStudio may update these Terms &amp; Conditions from time to time. Continued use of the site after changes constitutes acceptance of the revised terms.</p>
    </section>

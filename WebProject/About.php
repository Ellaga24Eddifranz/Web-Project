...
<head>
    ...
    <title>About Us | TrashPandaStudio</title>
...
<body>
    ...
    <header>
        ...
        <div class="header-right">
            ...
            <ul>
                ...
                <li><a href="#" class="active" onclick="return false;">About Us</a></li>
    ...
    <!-- ================= ABOUT HERO ================= -->
    <div class="hero page-hero about-hero">
        <h1>OUR STORY. YOUR VISION.</h1>
        <p>Driven by creativity and sharp adaptability. Our studio excels in graphic design, photo editing and modern media digital production</p>
    </div>
    ...
    <section class="services">
        ...
        <div class="values-grid">
            ...
            <div class="value-card">
                ...
                <p>Crafting bold logos &amp; cohesive brand guidelines. Building brands with lasting impact.</p>
            </div>

            <div class="value-card">
                <h3>Precision Photo Editing</h3>
                <p>Pixel-perfect retouching &amp; digital compositing. Perfecting your visuals one detail at a time.</p>
            </div>

            <div class="value-card">
                <h3>High-Conversion Graphics</h3>
                <p>Dynamic social kits &amp; vector promotional visuals. Converting engagement to results.</p>
            </div>
    ...
    <section class="founders">
        ...
        <div class="founders-grid">
            ...
            <div class="founder-card">
                <img class="zoomable" src="images/CEO 1.png" alt="Alcher S., Co-Founder & Creative Director">
                <h3>Alcher S.</h3>
                <p>Co-Founder &amp;<br>Creative Director</p>
            </div>

            <div class="founder-card">
                <img class="zoomable" src="images/CEO 2.png" alt="Eddifranz E., Founder & Strategy Lead">
                <h3>Eddifranz E.</h3>
                <p>Founder &amp;<br>Strategy Lead</p>
            </div>

            <div class="founder-bio">
                <h3>The Visions Behind TrashPandaStudio</h3>
                <p>United by a shared commitment to design excellence and enriched by diverse professional expertise, Eddifranz A. and Alcher S. founded TrashPandaStudio to provide uncompromising visual and strategic solutions for the fine art sector. Alcher's discerning creative direction is perfectly balanced by Eddifranz's incisive strategic foresight, ensuring both artistic integrity and market resonance. Together, they have built a studio synonymous with rigor, originality, and impact. Discover how their complementary partnership continues to define the distinctive narrative of TrashPandaStudio.</p>
            </div>

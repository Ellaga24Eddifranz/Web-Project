...
<head>
    ...
    <title>Services | TrashPandaStudio</title>
...
<body>
    ...
    <header>
        ...
        <div class="header-right">
            ...
            <ul>
                ...
                <li><a href="#" class="active" onclick="return false;">Services</a></li>
    ...
    <section class="brief-hero">
        <div class="brief-panel">
            ...
            <div class="brief-card brief-form">
                <h2 class="brief-heading">PROJECT BRIEF</h2>
                <p class="brief-subtext">Type or paste your project brief.</p>
                <input type="text" id="brief-title" class="field-input" placeholder="PROJECT TITLE">
                <textarea id="brief-desc" class="field-textarea" placeholder="PROJECT DESCRIPTION"></textarea>
            </div>

            <div class="brief-upload-col">
                <div class="brief-card dropzone" id="dropzone">
                    <img class="dropzone-icon" src="images/icon4.png" alt="Upload icon">
                    <p class="dropzone-title">DRAG &amp; DROP FILE</p>
                    <p class="dropzone-sub">Accepted file types: JPG, PNG, MP4<br>Max file size: 500MB</p>
                    <div id="brief-file-list" class="file-list"></div>
                    <input type="file" id="brief-file-input" accept=".jpg,.jpeg,.png,.mp4" multiple hidden>
                </div>
                <button type="button" class="btn btn-primary form-submit" id="brief-submit">SUBMIT COMPLETE BRIEF &amp; FILES</button>
            </div>
    ...
    <section class="services">
        ...
        <div class="steps-grid">
            ...
            <div class="step-card">
                <span class="step-badge">1. FILE ASSESSMENT</span>
                <p>Once you submit your files, our team carefully inspects them for formatting, resolution, or technical errors to ensure seamless processing.</p>
            </div>

            <div class="step-card">
                <span class="step-badge">2. DISCOVERY &amp; CONSULTATION</span>
                <p>We reach out directly using your preferred contact details for a brief alignment session to confirm your vision, goals, and project specifications.</p>
            </div>

            <div class="step-card">
                <span class="step-badge">3. PRODUCTION &amp; HANDOVER</span>
                <p>Our team gets to work while keeping you updated. Once complete, we notify you immediately so you can retrieve your project or have it delivered directly.</p>
            </div>
    ...
    <section class="founders">
        ...
        <div class="faq-grid">
            ...
            <div class="faq-card">
                <span class="faq-question">WHAT FILE FORMATS ARE ACCEPTED?</span>
                <p class="faq-answer">We accept all standard design and vector formats including .AI, .PDF, .EPS, .SVG, and high-resolution .PNG/.JPEG files.</p>
            </div>

            <div class="faq-card">
                <span class="faq-question">WHAT IS THE TURNAROUND TIME?</span>
                <p class="faq-answer">Most standard assessments and preliminary previews are completed within 24 to 48 hours. Expedited processing is also available upon request during the alignment phase.</p>
            </div>

            <div class="faq-card">
                <span class="faq-question">DO YOU OFFER REVISIONS?</span>
                <p class="faq-answer">Yes. Every project includes a standard review window where you can request tweaks or adjustments to ensure the final output matches your specifications.</p>
            </div>

            <div class="faq-card">
                <span class="faq-question">WHAT HAPPENS IF THERE ARE ERRORS IN MY ORIGINAL FILES?</span>
                <p class="faq-answer">During step 1 (File Assessment), our team flags any formatting, resolution, or color mode (CMYK/RGB) issues. We will notify you immediately during Step 2 before proceeding.</p>
            </div>

            <div class="faq-card">
                <span class="faq-question">HOW DO I TRACK THE STATUS OF MY PROJECT?</span>
                <p class="faq-answer">Once submitted, you'll receive updates via your preferred contact methods at key milestones (Assessment Complete, In Progress, and Ready for Handover).</p>
            </div>

            <div class="faq-card">
                <span class="faq-question">ARE THERE ANY SETUP FEES?</span>
                <p class="faq-answer">We don't charge setup fees for standard projects. Any complex setup requirements will be discussed upfront during Step 2.</p>
            </div>
    ...
    <section class="services">
        <h2 class="section-title">Service &amp; Pricing Plans</h2>
        <div class="pricing-grid">

            <div class="pricing-card">
                <div class="pricing-number">(1)</div>
                <span class="pricing-badge">ESSENTIAL FILE ASSESSMENT</span>
                <p class="pricing-features">
                    Comprehensive File Audit<br>
                    24hr priority<br>
                    +2 Bonus custom Shap Patches
                </p>
                <div class="pricing-price">&#8369;99.00</div>
            </div>

            <div class="pricing-card">
                <div class="pricing-number">(2)</div>
                <span class="pricing-badge">STANDARD FILE PREP</span>
                <p class="pricing-features">
                    Full Vector Conversion<br>
                    12hr Express<br>
                    Color Matching Pro.<br>
                    +5 Free Social Media Icon Templates
                </p>
            ...
            <div class="pricing-card">
                ...
                <span class="pricing-badge">PREMIUM FILE OPTIMIZATION</span>
                <p class="pricing-features">
                    Ultimate File Structuring<br>
                    6hr Super Express<br>
                    Multi-Format Master Files (PDF, SVG, EPS), unlimited revisions<br>
                    +1 Free Custom Vector Portrait
                </p>

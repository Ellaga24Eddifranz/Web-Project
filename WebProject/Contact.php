...
<head>
    ...
    <title>Contact | TrashPandaStudio</title>
    ...
    <header>
        ...
        <div class="header-right">
            ...
            <ul>
                ...
                <li><a href="#" class="active" onclick="return false;">Contact</a></li>
            </ul>
            </nav>
        </div>
    </header>
    ...
    <section class="contact-section">
        <div class="contact-grid">
            ...
            <div class="contact-col-left">
                <h2 class="contact-heading">Visit Us</h2>
                <img class="map-image" src="images/map.jpg" alt="Map showing TrashPandaStudio's location">

                <div class="contact-info-item">
                    <img src="images/contact1.png" alt="Location icon">
                    <span>3rd Floor, Leon Kilat Mall,<br>Negros Oriental</span>
                </div>

                <h2 class="contact-heading contact-heading-spaced">Direct Contact</h2>
                <div class="contact-info-item">
                ...
                <div class="contact-info-item">
                    ...
                    <span>TrashPandaStudio@gmail.com</span>
                </div>
            </div>
            ...
            <div class="contact-col-right">
                ...
                <form class="contact-form" id="contact-form">
                    <input type="text" id="contact-name" class="field-input" placeholder="Name">
                    <input type="email" id="contact-email" class="field-input" placeholder="Email">
                    <textarea id="contact-message" class="field-textarea" placeholder="Message"></textarea>
                    <button type="button" class="btn btn-primary form-submit" id="contact-send">SEND</button>
                </form>

                <div class="contact-socials">
                    <div class="contact-social-item">
                        <a href="#" class="social-icon-circle" aria-label="Facebook" onclick="showWipToast(event)">
                            <img src="images/contact7.png" alt="Facebook">
                        </a>
                        <span class="social-caption">/TrashPandaStudio<br>Official</span>
                    </div>
                    <div class="contact-social-item">
                        <a href="#" class="social-icon-circle" aria-label="Instagram" onclick="showWipToast(event)">
                            <img src="images/contact8.png" alt="Instagram">
                        </a>
                        <span class="social-caption">@TrashPandaStudio<br>Official</span>
                    </div>
                    <div class="contact-social-item">
                        <a href="#" class="social-icon-circle" aria-label="YouTube" onclick="showWipToast(event)">
                            <img src="images/contact9.png" alt="YouTube">
                        </a>
                        <span class="social-caption">TPS Diaries</span>
                    </div>
                </div>
            </div>
